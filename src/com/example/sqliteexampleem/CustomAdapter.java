...
public class CustomAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.textViewNames = (TextView) convertView.findViewById(R.id.tvName);//modify here
			viewHolder.textViewOrigin = (TextView) convertView.findViewById(R.id.tvOrigin);//modify here
			viewHolder.textViewAge = (TextView) convertView.findViewById(R.id.tvAge);//modify here
			viewHolder.textViewGender = (TextView) convertView.findViewById(R.id.tvGender);//modify here
