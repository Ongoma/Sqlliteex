...
public class Database extends SQLiteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		String sql="DROP TABLE IF EXISTS refugees";//modify to suit your table
		db.execSQL(sql);		
	}
   	/**
	 ...
	 * @param quantity
	 */
	public void save(String names,String origin,String age,String gender)//Modify here to suit what you want to save
	{
	  ...
	  values.put("gender", gender);//modify here
